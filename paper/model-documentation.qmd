...
$$
C = \int_{t_0}^{t_f}{f(\mathbf{l}_t\tau)}
$${#eq-cost} 

where $f(x)$ is a function that maps a percent reduction in potentially infectious contacts to a monetary value. At the time of the intervention, decision-makers do not have precise information about the costs of interventions $\tau$ or its costs represented by function $f(x)$.
