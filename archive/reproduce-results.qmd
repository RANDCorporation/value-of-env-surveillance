...
NPI effectiveness (i.e., the % reduction in infectious contacts caused by NPIs) had a non-monotonic effect on the value of surveillance systems to pandemic response (**Supplementary Figure X**). If NPI effectiveness is 0%, an improved surveillance system has no value, as expected. The value of the enhanced surveillance system increases with NPI effectiveness slowly for maximum NPI effectiveness below around 50%, and peaked when the maximum NPI effectiveness reaches 60%, enough to reduce the baseline R0 of 2.5 below 1 at pandemic outset. In general, we find that the value of the EWS peaks at a maximum NPI effectiveness value at $1-1/R0$, for different values of R0. Beyond that point, increases in NPI effectiveness result in lower total pandemic costs, but the value of the surveillance system starts to decrease.
