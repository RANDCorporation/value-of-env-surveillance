...
```
cd existing_repo
git remote add origin https://code.rand.org/plima/genomic-surveillance-voi.git
git branch -M main
...
- [ ] [Set up project integrations](https://code.rand.org/plima/genomic-surveillance-voi/-/settings/integrations)
