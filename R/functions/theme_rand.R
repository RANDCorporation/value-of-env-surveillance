...
#'   theme_rand()
#' }
theme_rand_ppt <- function(font = "Arial") {
  ...
  ggplot2::theme(
    # Plot
    plot.margin = ggplot2::margin(48, 48, 48, 16), # ggplot2::margin(4, 16, 4, 16)
    ...
    plot.caption.position = "panel", # "plot"
    ...
    panel.grid.major.y = ggplot2::element_blank(), # ggplot2::element_line(color = light_gray),
...
# Theme with font sizes optimized for the paper

theme_rand_paper <- function(font = "Arial") {
  dark_gray <- RandGrayPal[9]
  gray <- RandGrayPal[6]
  light_gray <- RandGrayPal[2]
